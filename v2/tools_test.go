...
// RoundTripFunc satisfies the requirements for http client so that we don't need a remote API that
// is actually active
...
var slugTests = []struct {
	...
	{name: "japanese string and romain characters", s: "hello world ハローワールド", expected: "hello-world", errorExpected: false},
}
...
var jsonTests = []struct {
	...
	{name: "unknown field in json", json: `{"frog": "1"}`, errorExpected: true, maxSize: 1024, allowUnknown: false},
	{name: "unknown field in json", json: `{"frog": "1"}`, errorExpected: false, maxSize: 1024, allowUnknown: true},
